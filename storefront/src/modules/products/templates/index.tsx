...
const ProductTemplate: React.FC<ProductTemplateProps> = ({
  ...
  return (
    <div className="flex flex-col gap-y-10 my-6">
      ...
      {/* Banner CTA se non loggato o non approvato */}
      {!minimalCustomer.isLoggedIn || !minimalCustomer.isApproved ? (
        <div className="content-container" data-testid="product-cta-login">
          <div className="rounded-xl border border-blue-200 bg-blue-50 p-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex-1">
              <h2 className="text-base md:text-lg font-semibold text-blue-900 mb-1">
                Accedi per vedere disponibilità e prezzi
              </h2>
              <p className="text-sm text-blue-800 leading-relaxed">
                Per consultare le disponibilità delle varianti e procedere con l'ordine è necessario avere un account attivo. Effettua l'accesso oppure registrati ora per richiedere l'abilitazione B2B.
              </p>
            </div>
