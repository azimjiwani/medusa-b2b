    ...
    <div className="product-page-constraint">
      <div className="flex flex-col gap-8 items-center text-center mb-8">
        ...
        <div className="flex flex-col gap-4 items-center text-center mb-16">
          <div className="w-full max-w-96 h-10 animate-pulse bg-gray-100"></div>
          <div className="w-48 h-10 animate-pulse bg-gray-100"></div>
        </div>
      </div>
      <ul className="grid w-full grid-cols-1 min-[640px]:grid-cols-2 small:grid-cols-3 medium:grid-cols-4 gap-5 flex-1">
        {repeat(3).map((index) => (
          <li key={index}>
