          ...
          <div className="flex flex-col gap-y-8 h-full col-span-1 row-span-2 flex-1">
            <div className="flex items-start gap-x-16 mb-6">
              <div className="flex flex-col gap-y-4">
                <h3 className="text-large-semi">{t("account.overview.profile")}</h3>
              ...
              <div className="flex flex-col gap-y-4">
                <h3 className="text-large-semi">{t("account.overview.addresses")}</h3>
                <div className="flex items-end gap-x-2">
                  <span
                    className="text-3xl-semi leading-none"
            ...
            <div className="flex flex-col gap-y-4">
              ...
              >
                {orders && orders.length > 0 ? (
                  ...
                  <span data-testid="no-orders-message">{t("account.overview.noRecentOrders")}</span>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-y-4">
              <div className="flex items-center gap-x-2">
                <Heading level="h3" className="text-xl text-neutral-950">
                  {t("account.overview.previouslyPurchased")}
                </Heading>
              </div>
              <div
                className="flex flex-col gap-y-2"
              ...
              >
                {orders && orders.length > 0 ? (
                  ...
                  <span data-testid="no-previously-purchased-items-message">
                    {t("account.overview.noPreviouslyPurchased")}
                  </span>
                )}
              </div>
            </div>
